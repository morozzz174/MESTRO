  ...
  static String _fieldLabel(String key, WorkType workType) {
    ...
    final allLabels = <String, Map<String, String>>{
      ...
      'foundations': {
        ...
        'foundation_height': 'Высота цоколя',
        'wall_thickness': 'Толщина стен фундамента',
        'has_sand_cushion': 'Песчаная подушка',
        'sand_cushion_thickness': 'Толщина песчаной подушки',
        'has_reinforcement': 'Армирование',
        'reinforcement_diameter': 'Диаметр арматуры',
        'reinforcement_layers': 'Количество слоёв арматуры',
        'concrete_grade': 'Марка бетона',
        'has_formwork': 'Опалубка',
        'formwork_material': 'Материал опалубки',
        'has_waterproofing': 'Гидроизоляция',
        'waterproofing_type': 'Тип гидроизоляции',
        'has_drainage': 'Дренажная система',
      ...
      'walls_box': {
        ...
        'wall_thickness': 'Толщина стены',
        'insulation_thickness': 'Толщина утеплителя',
        'has_armo_poyas': 'Армопояс',
        'armo_poyas_height': 'Высота армопояса',
        'window_count': 'Количество оконных проёмов',
        'window_avg_width': 'Средняя ширина окна',
        'window_avg_height': 'Средняя высота окна',
        'door_ext_count': 'Количество входных дверей',
        'has_internal_walls': 'Внутренние несущие стены',
        'internal_wall_length': 'Длина внутренних стен',
        'floor_slab_type': 'Тип перекрытий',
      },
      // Фасады
      'facades': {
        ...commonLabels,
        'facade_area': 'Общая площадь фасада',
        'facade_type': 'Тип отделки фасада',
        'has_insulation': 'Утепление фасада',
        'insulation_material': 'Материал утеплителя',
        'insulation_thickness': 'Толщина утеплителя',
        'color_scheme': 'Цветовая схема',
        'has_decor_elements': 'Декоративные элементы',
        'needs_scaffolding': 'Строительные леса',
        'scaffolding_height': 'Высота лесов',
        'building_floors': 'Этажность',
        'window_trim': 'Отделка откосов и отливов',
        'base_finish': 'Отделка цоколя',
      },
      // Кровля
      'roofing': {
        ...commonLabels,
        ...
        'roof_material': 'Материал кровли',
        'roof_slope_angle': 'Угол наклона ската',
        'rafter_step': 'Шаг стропил',
        'has_insulation': 'Утепление кровли',
        'insulation_thickness': 'Толщина утеплителя',
        'has_waterproofing_membrane': 'Гидроизоляционная мембрана',
        'has_vapor_barrier': 'Пароизоляция',
        'has_gutter': 'Водосточная система',
        'gutter_material': 'Материал водостока',
        'ridge_type': 'Тип конька',
        'has_snow_retention': 'Снегозадержатели',
        'building_width': 'Ширина здания',
        'building_length': 'Длина здания',
      },
      // Металлоконструкции
      'metal_structures': {
        ...commonLabels,
        'structure_type': 'Тип конструкции',
        'structure_length': 'Длина конструкции',
        'structure_width': 'Ширина конструкции',
        'structure_height': 'Высота конструкции',
        'metal_weight': 'Вес металла',
        'metal_profile': 'Тип проката',
        'has_antikorrosion': 'Антикоррозийная обработка',
        'antikorrosion_type': 'Тип обработки',
        'connection_type': 'Тип соединений',
        'has_concrete_foundation': 'Нужен фундамент',
        'foundation_type': 'Тип фундамента',
        'installation_height': 'Высота монтажа',
        'has_delivery': 'Требуется доставка',
        'site_access': 'Подъезд к объекту',
      },
      // Инженерные сети наружные
      'external_networks': {
        ...commonLabels,
        'network_type': 'Тип сети',
        'trench_length': 'Длина траншеи',
        'trench_depth': 'Глубина заложения',
        'trench_width': 'Ширина траншеи',
        'pipe_material': 'Материал трубы',
        'pipe_diameter': 'Диаметр трубы',
        'has_wells': 'Колодцы/смотровые камеры',
        'wells_count': 'Количество колодцев',
        'well_material': 'Материал колодцев',
        'has_horizontal_boring': 'Горизонтальное бурение (ГНБ)',
        'boring_length': 'Длина бурения',
        'soil_type': 'Тип грунта',
        'has_road_crossing': 'Пересечение дорог',
