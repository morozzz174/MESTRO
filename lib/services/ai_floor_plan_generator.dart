...
class AIFloorPlanGenerator {
  ...
  // ===== Фундаменты =====
  FloorPlan _generateFoundationPlan(
  ...
  // ===== Коробка (стены) =====
  FloorPlan _generateWallsBoxPlan(
    Map<String, dynamic> data,
    Order order,
  ) {
    ...
    if (hasInternalWalls) {
      ...
      rooms.add(Room(
        ...
        doors: [
          Door(x: 0, y: 1.0, width: 0.9, type: DoorType.entrance),
        ],
        windows: [
      ...
      rooms.add(Room(
        ...
        windows: [
          const Window(x: 0.5, y: 0, width: 1.2, sillHeight: 0.9),
        ],
        hasBalconyAccess: false,
        hasVentilation: true,
      ));
      ...
      rooms.add(Room(
        ...
        windows: [
          const Window(x: 0.3, y: 0, width: 0.4, sillHeight: 1.2),
        ],
        hasBalconyAccess: false,
        hasVentilation: true,
      ));
  ...
  // ===== Фасады =====
  FloorPlan _generateFacadesPlan(
    Map<String, dynamic> data,
    Order order,
  ) {
  ...
  // ===== Кровля =====
  FloorPlan _generateRoofingPlan(
    Map<String, dynamic> data,
    Order order,
  ) {
    ...
    if (area != null && area > 10) {
      ...
      for (int i = 0; i < roomsCount; i++) {
        ...
        rooms.add(Room(
          ...
          windows: [
            Window(x: 0.5, y: 0, width: 1.2, sillHeight: 0.9),
          ],
          hasBalconyAccess: false,
          hasVentilation: true,
        ));
      ...
      rooms.add(Room(
        ...
        width: widthM,
        height: heightM,
        doors: [const Door(x: 0.5, y: 0, width: 0.9, type: DoorType.entrance)],
  ...
  double _sqrt(double value) {
    if (value <= 0) return 1;
    return value < 0.0001 ? 0.01 : value < 0.01 ? 0.1 : _sqrtInternal(value);
  }
